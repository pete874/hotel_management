...
namespace hotel_management
{
    class VARAUS
    {
        ...
        public bool LisaaVaraus(String tyontekija, String huonetyyppi, int huonenro, String sisaan, String ulos)
        {
            ...
            //tallennetaan lisayskyselyssä tulleiden rivien määrä
            int count = Convert.ToInt32(komento.ExecuteScalar());
            ...
            if (count < 1)
            {
                ...
                komento2.Parameters.Add("@hnu", MySqlDbType.Int32).Value = huonenro;
                komento2.Parameters.Add("@sis", MySqlDbType.Date).Value = sisaan;
                komento2.Parameters.Add("@ulo", MySqlDbType.Date).Value = ulos;
                yhteys.avaaYhteys();
